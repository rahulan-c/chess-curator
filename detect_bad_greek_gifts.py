...
Slack.
Objective: 1) identify likely Greek gift sacs by White
Current version:
Checkessimplified sac detection techniques to games
candidate Greek gift sacrifices by White. Assess the quality of each sac
using Stockfish 14.1, and return a list of good and bad sacs.
"""
